...
public  class openBrowser {
	...
	public WebDriver open(String browser) throws MalformedURLException {
		...
		if(browser.equals("firefox")) {
			System.setProperty("webdriver.gecko.driver","src\\main\\java\\bin\\geckodriver.exe");
			...
			System.setProperty("webdriver.chrome.driver", "src\\main\\java\\bin\\chromedriver.exe");
